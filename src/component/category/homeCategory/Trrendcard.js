...
const Trrendcard = () => {
  const menData = data.men.slice(2, 4); // Select first two male items
  const womenData = data.women.slice(2, 4); // Select first two female items
